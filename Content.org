...
My worries for today's{{{marginnote(https://adventofcode.com/2024/day/19)}}} puzzle being very difficult were unfounded. Which makes me more concerned for the weekend.
...
This is an application of the Change-making problem{{{marginnote(https://en.wikipedia.org/wiki/Change-making_problem)}}}.
...
I still have some left-over challenges to finish and I'd rather work on them rather than tidy this up to be better code. Yes, there is repetition, but that doesn't bother me as much as it seems to for other people. For more, see my Ted talk on why DRY is a scam{{{sidenote(There is no talk, but I do think excessive application of DRY may lead to unwanted coupling)}}}.
