...
I was expecting a Graph{{<sidenote>}}https://adventofcode.com/2024/day/9{{</sidenote>}} problem to show up around now, and it as a good time to create a utility `Grid` class to make working with these 2D graphs a little easier.
